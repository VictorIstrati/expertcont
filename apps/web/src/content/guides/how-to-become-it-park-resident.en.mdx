...
The preferential tax regime is guaranteed by law **until 2035**, and the Park's operation is secured **until 2037**. This legislative guarantee is essential for companies planning medium- and long-term investments — Moldova IT Park is not a temporary facility but a structural component of national economic policy.
...
- Personal income tax withheld from salaries (19.4%)
...
The 70% threshold is checked **monthly and cumulatively year-to-date**. The activity must remain concentrated on eligible areas throughout the entire fiscal year.
...
In practice, this is the most sensitive criterion. For each full-time employee, **the minimum single tax amount is approximately MDL 5,220 per month** (30% of the national average wage for 2026, projected at MDL 17,400).
...
The MITP Administration reviews the application and issues a decision, as a rule, **within 10–20 business days**. If approved, the company receives a **resident certificate**, indicating the date from which the preferential tax regime applies.
...
- **Reporting via the STS system** (the specific declaration for IT Park residents)
...
One of the most sensitive monthly obligations is monitoring **the proportion of revenue from eligible activities**. If in any month this proportion falls below 70% on a cumulative annual basis, the company risks losing status. We recommend:
